    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className=" flex items-center space-x-3 ">
                  ...
                  <p className="opacity-50 text-sm">23222 Rating</p>
                  <p className="ml-3 text-sm font-medium text-indigo-6000 hover:text-indigo-500">
                    356246 Reviews
                  </p>
                </div>
              </div>
        ...
        <section>
          ...
          <div className="border border-opacity-20   p-5">
            {/* Grid1 */}
            <Grid container spacing={7}>
              ...
              <Grid item xs={5} className="m-auto">
                ...
                <div className=" flex items-center space-x-3">
                    ...
                    <p className="opacity-60">55563 Ratings</p>
                </div>
